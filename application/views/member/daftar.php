    ...
    <div class="row d-flex align-items-left justify-content-center h-100">
      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
			<?php if($this->session->flashdata('success')){ ?>
                ...
                <?php } ?>
                <form action="<?= base_url('member/tambahmember') ?>" method="post">
          <!-- Email input -->
		  <div class="form-outline mb-4">	<br>
			<label class="form-label" for="form1Example13">NIK</label>
            <input type="number" name="nik"  class="form-control form-control-lg" placeholder="NIK" />
          </div>
	  ...
	  <div class="form-outline mb-4">	
			<label class="form-label" for="form1Example13">Alamat Lengkap</label>
            <input type="text" name="alamat"  class="form-control form-control-lg" placeholder="Alamat Lengkap" />
          </div>
		  <div class="form-outline mb-4">	
			<label class="form-label" for="form1Example13">Pekerjaan</label>
            <input type="text" name="pekerjaan"  class="form-control form-control-lg" placeholder="Pekerjaan" />
          </div>
          <div class="form-outline mb-4">	
		...
		<p>Sudah Menjadi member ? Klik <a href="<?= base_url('member')?>">disini</a> untuk login 
		  <!-- Submit button -->
