	 ...
	 <div class="col-md-6">
			...
			<?php if($this->session->flashdata('success')){ ?>
                ...
                <?php } ?>
					 ...
					 <form action="<?php echo base_url().'admin/gedung/update/'; ?>" method="post">
					<!-- Form Imputan -->
					<input type="hidden" name="id_order" class="form-control"value="<?php echo $ds->id_order?>">
					<div class="form-outline mb-4">
					<label class="form-label" for="form1Example23">Nama Customer</label>
					...
					<label class="form-label" for="form1Example23">Alasan</label>
           			 <input type="text" name="tambahan" class="form-control form-control-lg" placeholder="Alasan Tidak Diterima"   />
          			</div>
